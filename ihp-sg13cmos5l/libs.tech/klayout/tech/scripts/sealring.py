...
def generate_sealring(width: float, length: float, input: str | None, output: str, offset_x: float, offset_y: float):
    ...
    :type width: float
    :param length: Length (Y-Axis) of the sealring.
    :type length: float
...
generate_sealring(width, length, input, output, offset_x, offset_y)  # pylint: disable=undefined-variable
